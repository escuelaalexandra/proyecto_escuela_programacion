  ...
  services: [
    { 
      ...
      details: [
        ...
        "Dictamen técnico de estado de fondos en el sistema interbancario.",
        "Representación y aclaración técnica ante la entidad emisora/receptora."
      ],
      detalles: [
        "Rastreo de claves de rastreo (CEP) e inconsistencias bancarias.",
        "Dictamen técnico de estado de fondos en el sistema interbancario.",
    ...
    { 
      ...
      details: [
        ...
        "Gestión de reportes y controversias en canales institucionales.",
        "Blindaje de cuentas contra vulneraciones recurrentes."
      ],
      detalles: [
        "Auditoría de seguridad en movimientos no autorizados.",
        "Gestión de reportes y controversias en canales institucionales.",
    ...
    { 
      id: "patrimonial",
      title: "Representación y Defensoría Patrimonial",
      ...
      details: [
        ...
        "Acompañamiento en procesos de conciliación e investigación.",
        "Estrategias de resguardo para cuentas institucionales y particulares."
      ],
      detalles: [
        "Elaboración de expedientes para la protección de activos.",
        "Acompañamiento en procesos de conciliación e investigación.",
